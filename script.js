...
function showDescription(event) {
    ...
    if (project.id === "project0") {
        ...
        description.innerHTML = "<a class='projectLink' href=https://khamerling-potts.github.io/todo-react/>Open To Do List app</a> <br><br>This project utilizes React and JavaScript to create an interactive to do list. The user can add items, delete items, mark items as complete, and sort items alphabetically."
    }
